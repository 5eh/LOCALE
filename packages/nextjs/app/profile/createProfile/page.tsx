...
const listings = [
  ...
  },
  {
    ...
    location: 'Austin Texas',
    description:
      'This is an in-depth description about something super cool...',
  },
  {
    id: 'LISTINGID2',
    date: '2023 - FEB 16',
    ...
    <>
      <div className='bg-gray-900'>
        ...
        <main className='relative isolate'>
          ...
          <div
            id='main'
            className='mx-auto mt-12 pt-24 max-w-7xl px-4 sm:px-6 lg:px-8'
          >
                ...
                <div className=' rounded-lg flex items-center'>
                  ...
                  <div className='pl-3'>
                    ...
                    <p className='italic text-gray-400'>
                      <a href='https://ocovos.com/${OCOVOSSTUDIOS}'>
                        @OCOVOSSTUDIOS
                      </a>
                    </p>
                  </div>
              ...
              <div className='text-yellow-400 p-4 md:col-span-2 lg:col-span-1'>
                ...
                <div className='mt-2 pb-2'>
                  <div className='mt-2 pb-2'>
                    <ul role='list'>
                      <li
                        key={currentReview.userID}
                        className='col-span-1 divide-y'
                      >
                        <div className='flex w-full items-center justify-between space-x-6 p-6'>
                          <div className='flex-1 truncate'>
                            <div className='flex items-center space-x-3'>
                              <h3 className='truncate text-md font-medium text-gray-300'>
                                {currentReview.name}
                              </h3>
                              <span className='ml-2 mr-2 inline-flex items-center gap-x-0.5 rounded-md bg-blue-300 px-2 py-1 text-xs font-medium text-blue-800 ring-1 ring-inset ring-blue-800/10'>
                                {currentReview.badge}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 pt-4'>
              ...
              <div className='col-span-1 '>
                {listings.map((listing) => (
                  <div key={listing.id}>
                    <a
                      href={`https://ocovosfashion.com/listings/${listing.id}`}
                    >
                      <div className='bg-gray-800/20 hover:bg-gray-700/20 p-4 shadow rounded-lg mt-2 mb-2'>
                        ...
                        <p className='text-gray-300 mb-1 mt-1'>
                          {listing.location}
                        </p>
                        <p className='font-sm text-white mt-1 mb-1 pl-1 pr-1'>
                          {listing.description}
                        </p>
              ...
              <div className='gap-4 p-4 col-span-1 w-full'>
                <div className='inline-flex flex-col mt-2 mb-2 gap-2 ring-1 ring-gray-500 rounded-md bg-gray-800 border border-gray-700 px-4 py-2 text-xs font-medium text-gray-200 hover:bg-gray-900 hover:text-white'>
                  ...
                  <p>
                    Subscribe to their account to get access to their latest

// src/app/explore/listingsTest.tsx
...
export default function TestListing({ creator, listing }: DataProps) {
                    ...
                    <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                      <div className="rounded-2xl lg:pr-10 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                        ...
                        <div className="mt-10 flex items-center gap-x-2">
                          ...
                          <Link key={listing.listingID} href={`/explore/purchase/${listingID}`}>
